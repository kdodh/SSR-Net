...
def visualize_segmentation(image, prediction, label,save_path):
    import nibabel as nib
    prediction = resample_3d(prediction, (148,512,512))
    nib.save(nib.Nifti1Image(prediction.astype(np.uint8), None), './out.nii.gz')
...
def test_single_volume(image, label, net, classes, patch_size=[256, 256], test_save_path=None, case=None, z_spacing=1):
    ...
    save_path = os.path.join(save_dir, f'{case}_visualization.png')

    visualize_segmentation(image, prediction, label,save_path)
