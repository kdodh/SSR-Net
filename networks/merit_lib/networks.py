...
def load_pretrained_weights(img_size, model_scale):
    ...
    if(model_scale=='tiny'):
        if img_size==224:
            ...
            state_dict = torch.load('./maxvit_rmlp_small_rw_224_sw-6ef0ae4f.pth.1')
        elif(img_size==256):
        ...
        if img_size==224:
            ...
            state_dict = torch.load('/home/top/phj/MSA-2Net01/maxvit_rmlp_small_rw_224_sw-6ef0ae4f.pth.1')
        elif(img_size==256):
