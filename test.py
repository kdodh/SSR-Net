...
parser.add_argument("--noise_type", type=str, default = 'none', help = 'each noises hyperparams must be checked')
parser.add_argument('--weights_fpath', type=str,default='weights file path', help='weights file path') # path for best model's weights
parser.add_argument("--model_name", type=str, default="SSRNet", help="model_name")
parser.add_argument(
    "--opts",
...
def inference(args, model, test_save_path=None):
    ...
    for i_batch, sampled_batch in tqdm(enumerate(testloader)):
        ...
        print('***************************************************')
        print('***************************************************')
        print('metric_i', metric_i[0])
        print('metric_i', metric_i[1])
        print('metric_i', metric_i[2])
        print('metric_i', metric_i[3])
        print('metric_i', metric_i[4])
        print('metric_i', metric_i[5])
        print('metric_i', metric_i[6])
        print('metric_i', metric_i[7])
